...
class PixelosApp extends LitElement {
  ...
  static styles = css`
    :host {
      ...
      --md-sys-color-primary: #a7f3da;
      --md-sys-color-on-primary: #00382a;
      --md-sys-color-primary-container: #2f6b56;
      --md-sys-color-on-primary-container: #d7ffef;
      --md-sys-color-secondary: #c2d8ce;
      --md-sys-color-on-secondary: #233a31;
      --md-sys-color-secondary-container: #4a6258;
      ...
      --md-sys-color-on-surface: #e5efe9;
      --md-sys-color-surface-container-low: #1a2b26;
      --md-sys-color-surface-container: #1f322c;
