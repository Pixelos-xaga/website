...
class PixelosApp extends LitElement {
  ...
  static styles = css`
    :host {
      ...
      --md-sys-color-primary: #8de8c9;
      --md-sys-color-on-primary: #003729;
      --md-sys-color-primary-container: #00513d;
      --md-sys-color-on-primary-container: #aaf5db;
      --md-sys-color-secondary: #b3ccc1;
      --md-sys-color-on-secondary: #1f352c;
      --md-sys-color-secondary-container: #364b43;
      --md-sys-color-on-secondary-container: #d0e9de;
      --md-sys-color-tertiary: #9fd8dd;
      --md-sys-color-on-tertiary: #00363a;
      --md-sys-color-background: #0d1513;
      --md-sys-color-on-background: #dce5df;
      --md-sys-color-surface: #101917;
      --md-sys-color-on-surface: #dce5df;
      --md-sys-color-surface-container-low: #14201c;
      --md-sys-color-surface-container: #182520;
      --md-sys-color-surface-container-high: #22312b;
      --md-sys-color-surface-container-highest: #2b3b34;
      --md-sys-color-outline: #87988f;
      --md-sys-color-on-surface-variant: #bdcec5;
